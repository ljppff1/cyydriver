...
public class WritePadDialog extends Dialog {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		p.height = getWindow().getWindowManager().getDefaultDisplay().getHeight();//(int) (d.getHeight() * 0.4);   //高度设置为屏幕的0.4 
		p.width = getWindow().getWindowManager().getDefaultDisplay().getWidth();//(int) (d.getWidth() * 0.6);    //宽度设置为屏幕的0.6		   
